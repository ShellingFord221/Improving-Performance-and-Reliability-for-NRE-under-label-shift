...
class ModelWithTemperature(nn.Module):
    ...
    def __init__(self, model, label_num, device):
        ...
        self.temperature = nn.Parameter(torch.ones(label_num))   # VS
    ...
    def scale_temperature(self, logits):
        ...
        """
        return logits * self.temperature.cuda() + self.systematic_bias.cuda()
    ...
    def set_temperature(self, dset):
        ...
        # ece_calibrated = self.make_model_diagrams(new_logits, labels, fig_name + '_VS')
