...
dev_ratio = 0.2
cvnum = 100
result_file_LA_calibrate = './bert_' + DATASET + '_LA_calibrate.txt'
...
print('Calibrated LA Test F1 is:', f1)


result_file = open(result_file_LA_calibrate, 'w', encoding='UTF-8')
